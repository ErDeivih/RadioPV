...
from .routers import auth, tracks, artists, library, playlists, recommend, stream, facets, wrapped, follows, stats, admin, collector, lyrics
...
for r in (auth.router, tracks.router, artists.router, library.router, playlists.router, recommend.router, stream.router, facets.router, wrapped.router, follows.router, stats.router, admin.router, collector.router, lyrics.router):
